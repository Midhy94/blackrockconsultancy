...
const whatsappNumber = '918169750432'
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <a href="tel:+918169750432" className="block text-secondary hover:text-primary transition-colors">+91 81697 50432</a>
                  <svg
                    viewBox="0 0 24 24"
                    width="16"
                    height="16"
                ...
                <div className="pt-4 mt-2 border-t border-gray-100">
                  <p className="text-dark font-medium text-sm mb-2">Middle East Point of Contact</p>
                  <a
                    href="tel:+966534480049"
                    className="block text-secondary hover:text-primary transition-colors"
                  >
                    Mobile: +966 53 448 0049 - Mr. James
                  </a>
                </div>
              </div>
            </div>
